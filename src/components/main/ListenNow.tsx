...
const ListenNow: React.FC = () => {
  ...
  return (
    <RowCol rowClasses="row justify-content-center" colClasses="col-11 col-sm-10">
      <SubHeading
        ...
        <div className={`row align-items-center ${styles.gap}`}>
          <div className="col-12 col-md-7 col-lg-9">
            <p className={styles["listen-now-description"]}>
              3 Idiots and a Star Wars Podcast is currently available on Spotify
              and Apple Podcasts. Join the hosts Landon, Alex, and Nathan as
              they discuss all the latest Star Wars news.
            </p>
          </div>
